...
DEFAULT_PROJECT_PROMPT_TEMPLATE = (
    ...
    "- Post status updates and questions as comments.\n"
    "- If you need help or clarification, ask in a comment and include a line starting with 'BLOCKER:' summarizing what you need.\n"
